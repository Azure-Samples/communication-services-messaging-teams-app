...
<img src="./Assets/chat-start1.png" alt="Chat start floating button" style="margin-top: 20px; margin-bottom: 20px;"> <img src="./Assets/chat-start2.png" alt="Chat start window" style="margin-top: 20px; margin-bottom: 20px;">
